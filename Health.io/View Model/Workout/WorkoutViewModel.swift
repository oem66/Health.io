...
final class WorkoutViewModel {
    var workouts = [
        Workout(title: "Lose Weight", subtitle: "Fat Burning", numberOfWorkouts: 10, image: "builder"),
        ...
        Workout(title: "Lose Fat", subtitle: "Fat Burning", numberOfWorkouts: 10, image: "builder"),
